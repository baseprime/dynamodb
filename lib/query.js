...
Query.prototype.exclusiveStartKey = function (key) {
...
Query.prototype.clone = function () {
  var query = new Query(this.hashKey, this.table, this.serializer);
  query.request = _.cloneDeep(this.request);
  query.options = _.cloneDeep(this.options);
  return query;
};
